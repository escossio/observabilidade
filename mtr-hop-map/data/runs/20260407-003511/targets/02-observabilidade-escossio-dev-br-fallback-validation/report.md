...
- slug do destino: `observabilidade-escossio-dev-br-fallback-validation`
...
- source: `mtr-hop-map`
- target: `observabilidade.escossio.dev.br-fallback-validation`
- target_slug: `observabilidade-escossio-dev-br-fallback-validation`
- mode: `replay`
