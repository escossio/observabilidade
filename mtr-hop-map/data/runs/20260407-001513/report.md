...
- 12: `187.19.161.199` - `AS28126` - `BRISANET SERVICOS DE TELECOMUNICACOES S.A` - origem `whois-cymru`
- 13: `172.67.131.172` - `AS13335` - `Cloudflare, Inc.` - origem `whois-cymru`

## Hosts reconciliados

- criados na fase 1: `-`
- reaproveitados na fase 1: `-`
- atualizados na fase 1: `10780, 10781, 10782, 10783, 10784, 10785, 10786, 10787, 10788, 10789, 10790, 10791, 10792`

## Idempotencia

- mapa criado na fase 1: `False`
- mapa criado na fase 2: `False`
- hostids fase 1: `10791, 10792, 10780, 10781, 10782, 10783, 10784, 10785, 10786, 10787, 10788, 10789, 10790`
- hostids fase 2: `10791, 10792, 10780, 10781, 10782, 10783, 10784, 10785, 10786, 10787, 10788, 10789, 10790`
- linkids fase 1: `67, 68, 69, 70, 71, 72, 73, 74, 75, 76, 77, 79`
- linkids fase 2: `67, 68, 69, 70, 71, 72, 73, 74, 75, 76, 77, 79`
